...
<div class="wrapper">
    <div class="header">
        ...
        <h1>Bienvenido al Portal Docente</h1>
        <p class="header-sub">Tu cuenta de acceso ha sido activada</p>
        <div class="header-band"></div>
    </div>

    <div class="body">
        <p class="greeting">Estimado/a {{ $profesor->nombre }},</p>
        <p>Se ha activado tu cuenta de acceso al portal docente de la UICM. A continuación encontrarás tus credenciales:</p>
        ...
        <div class="signature">
            Atentamente,<br>
            <strong>Coordinación Académica — UICM</strong>
        </div>
    </div>
