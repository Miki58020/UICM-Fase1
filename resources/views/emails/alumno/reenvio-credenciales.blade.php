...
<head>
    ...
    <title>Actualización de credenciales — UICM</title>
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .badge { display: inline-block; background: #EFAD5A; color: #fff; font-family: Arial, sans-serif; font-weight: bold; font-size: 15px; letter-spacing: 2px; padding: 10px 28px; border-radius: 30px; border: 2px solid #d4923a; }
        ...
        .alert-box { background: #fff8f0; border-left: 4px solid #EFAD5A; border-radius: 0 8px 8px 0; padding: 16px 20px; margin: 20px 0; font-family: Arial, sans-serif; font-size: 14px; color: #7a4a00; }
...
<div class="wrapper">
    ...
    <div class="header">
        ...
        <p class="header-sub">Se ha generado una nueva contraseña para tu cuenta</p>
    ...
    <div class="body">
        ...
        <p>A solicitud del área de Control Escolar, se ha generado una nueva contraseña para tu acceso al portal estudiantil. Tus credenciales actualizadas son las siguientes:</p>

        <div class="badge-wrap">
            <span class="badge">CREDENCIALES ACTUALIZADAS</span>
        </div>
        ...
        <div class="alert-box">
            Si <strong>no solicitaste</strong> este cambio de contraseña, comunícate con Control Escolar a la brevedad.
        </div>

        <div class="info-box">
            Una vez que ingreses al portal, puedes <strong>cambiar tu contraseña</strong> desde la sección de seguridad de tu cuenta.
        </div>
