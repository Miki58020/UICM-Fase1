        ...
        <nav class="flex-1 px-3 py-3">
            ...
            <a href="{{ route('admin.tarifas.index') }}"
               ...
               class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-base font-medium transition-colors duration-150
                ...
                <span class="nav-link-text">Tarifas de inscripción</span>
            </a>
            ...
            <a href="{{ route('admin.mercadopago.index') }}"
               @click="sidebarOpen = false"
               data-tooltip="MercadoPago"
               class="nav-link flex items-center gap-3 px-3 py-2.5 rounded-lg text-base font-medium transition-colors duration-150
                      {{ request()->routeIs('admin.mercadopago.*') ? 'bg-white/20 text-white' : 'text-green-100 hover:bg-white/10 hover:text-white' }}">
                <svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                          d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/>
                </svg>
                <span class="nav-link-text">MercadoPago</span>
            </a>
            @endif
