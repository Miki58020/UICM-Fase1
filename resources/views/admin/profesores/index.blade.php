...
<div x-data="{
    ...
    abrir() {
        this.editando = null;
        this.form = { nombre: '', correo: '', telefono: '', especialidad: '', password: '' };
        this.showPwd = false;
        this.showModal = true;
    },
    abrirEditar(p) {
        this.editando = p;
        this.form = { nombre: p.nombre, correo: p.correo, telefono: p.telefono ?? '', especialidad: p.especialidad ?? '', password: '' };
        this.showPwd = false;
        this.showModal = true;
    },
    get accion() {
                        ...
                        <tr class="hover:bg-gray-50 transition-colors duration-100">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center gap-3">
                                    <div class="flex-shrink-0 w-8 h-8 rounded-full overflow-hidden border-2"
                                         style="border-color: #0F4229;">
                                        @if($profesor->user?->foto)
                                            <img src="{{ route('admin.archivo', ['path' => $profesor->user->foto]) }}"
                                                 alt="Foto de perfil"
        ...
        <form method="POST" :action="accion">
            ...
            <div class="px-6 py-5 space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onfocus="this.style.borderColor='#0F4229'; this.style.boxShadow='0 0 0 3px rgba(15,66,41,0.12)'"
                            onblur="this.style.borderColor='#E5E7EB'; this.style.boxShadow='none'">
                        <p class="mt-1 text-xs text-gray-400">Solo 10 dígitos, sin espacios ni guiones.</p>
                    </div>
                ...
                <div x-show="editando" x-cloak>
                    <label class="block text-xs font-semibold text-gray-600 mb-1.5 uppercase tracking-wide">
                        Nueva contraseña
                        <span class="normal-case font-normal text-gray-400 ml-1">(dejar vacío para no cambiar)</span>
                    </label>
                    <div class="relative">
                        <input
            ...
            <div class="px-6 py-4 border-t border-gray-100 flex items-center justify-end gap-3">
                ...
                <button
                    type="submit"
                    class="inline-flex items-center gap-2 px-5 py-2 rounded-xl text-sm font-bold text-white shadow-sm
                           transition-colors duration-150"
                    style="background-color: #0F4229;"
                    onmouseover="this.style.backgroundColor='#0a2e1c'"
                    onmouseout="this.style.backgroundColor='#0F4229'">
