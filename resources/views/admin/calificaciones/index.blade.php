            ...
            <div class="bg-white rounded-2xl shadow-md overflow-hidden" x-data="{ rechazando: false }">
                ...
                <div class="px-6 py-8">
                    <div class="flex flex-col items-center text-center">
                        ...
                        <p class="text-sm text-gray-500 max-w-xs mx-auto">Aún no hay calificaciones que revisar.</p>
                    </div>
                </div>
                @else
                            ...
                            <tr>
                                <td colspan="6" class="px-6 py-10">
                                    <div class="flex flex-col items-center text-center">
                                        ...
                                        <h3 class="text-base font-extrabold text-gray-900 mb-1">Sin resultados</h3>
                                        <p class="text-sm text-gray-500 max-w-xs mx-auto">No hay alumnos en este grupo.</p>
                                    </div>
                                </td>
                            </tr>
                            @endforelse
