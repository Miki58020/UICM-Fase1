                ...
                @if ($conteo['total'] === 0)
                    <div class="px-6 py-10">
                        <div class="flex flex-col items-center text-center">
                            ...
                            <p class="text-sm text-gray-500 max-w-xs mx-auto">No hay alumnos activos registrados.</p>
                        </div>
                    </div>
                @else
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-10">
                                <div class="flex flex-col items-center text-center">
                                    ...
                                    <h3 class="text-base font-extrabold text-gray-900 mb-1">Sin resultados</h3>
                                    <p class="text-sm text-gray-500 max-w-xs mx-auto">No se encontraron alumnos con ese criterio.</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
