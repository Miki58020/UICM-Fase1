...
<section class="bg-uicm-gray min-h-screen py-12">
    <div class="container mx-auto px-4 sm:px-8 lg:px-24">
        ...
        <div class="text-center mb-8">
            ...
            <div class="mx-auto w-20 h-1 rounded-full mb-5" style="background-color: #D4AF37;"></div>

            {{-- Guía descargable del proceso --}}
            <a href="{{ asset('manuales/guia-registro-aspirante.pdf') }}"
               target="_blank"
               class="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-semibold border transition-colors duration-150"
               ...
               onmouseout="this.style.backgroundColor='transparent'">
                ...
                Descargar guía del proceso (PDF)
            </a>
        </div>
