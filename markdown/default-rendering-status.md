...
> Nota
>
> Para consultar los tipos y especificaciones de los parámetros y respuestas de las funciones del Brick, consulta la [documentación técnica](https://github.com/mercadopago/sdk-js/blob/main/docs/bricks/status-screen.md).
...
El `paymentId` que se debe enviar a Brick para su inicialización es el ID que devuelve la [API de Pagos](/developers/es/reference/online-payments/checkout-api-payments/create-payment/post) al generar un pago con Mercado Pago.
