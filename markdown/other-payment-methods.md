...
Para configurar **pagos con dinero en efectivo via ticket**, envía un POST con los siguientes parámetros al endpoint [/v1/payments](/developers/es/reference/online-payments/checkout-api-payments/create-payment/post) y ejecuta la solicitud o, si lo prefieres, utiliza uno de nuestros SDKs indicados a continuación.
...
> Importante
>
> La fecha de vencimiento del boleto se puede configurar enviando una solicitud POST con el parámetro `data_of_expiration` al endpoint [/v1/payments.](/developers/es/reference/online-payments/checkout-api-payments/create-payment/post) Después del vencimiento, el boleto será cancelado.
