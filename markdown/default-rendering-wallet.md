...
> NOTE
>
> Para consultar los tipos y especificaciones de los parámetros y respuestas de las funciones del Brick, consulta la [documentación técnica](https://github.com/mercadopago/sdk-js/blob/main/docs/bricks/wallet.md).
...
![wallet-brick-render](checkout-bricks/wallet-brick-render-es-all-v1.png)
