...
Puedes adaptar la integración de Payment Brick a tu modelo de negocio configurando [atributos de preferencia](/developers/es/reference/online-payments/checkout-pro/preferences/create-preference/post).
