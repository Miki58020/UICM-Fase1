...
Finalmente, al hacer clic en **Pagar**, se activa la _callback_ `onSubmit`, que envía los datos de pago al endpoint especificado en su backend. Los datos proporcionados por esta _callback_ ya están formateados según el contrato de la [API de pagos](/developers/es/reference/online-payments/checkout-api-payments/create-payment/post).
