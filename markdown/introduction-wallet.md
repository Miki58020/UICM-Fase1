...
![wallet-brick-theme](checkout-bricks/wallet-brick-theme-es-all-v1.png)

> Si deseas cambiar el texto y el aspecto predeterminado del Brick, consulta las secciones de [Cambiar textos](/developers/es/docs/checkout-bricks/wallet-brick/visual-customizations/change-texts) y [Cambiar de aspecto,](/developers/es/docs/checkout-bricks/wallet-brick/visual-customizations/change-appearance) respectivamente.